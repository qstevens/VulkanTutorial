...
private:
    ...
    void createInstance() {
        ...
        if (enableValidationLayers) {
            ...
            populeDebugMessengerCreateInfo(debugCreateInfo);
    ...
    void populeDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
    {
        createInfo = {};
    ...
    void setupDebugMessenger() {
        ...
        populeDebugMessengerCreateInfo(createInfo);
    ...
    VkSurfaceFormatKHR chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
        // Check for preferred format combination
        ...
        // OPTION: Can score available formats and choose the best one
    ...
    void pickPhysicalDevice() {
        ...
        // Ordered map of candidate physical devices
    ...
    int rateDeviceSuitability(VkPhysicalDevice device) {
        ...
        // Check for compatible queue families
